...
extern void* admin_thread(void *args);
...
int main(int argc, char *argv[])
{
	...
	log_set_program_info("PGVIP", "PGVIP is a PostgreSQL master-standby auto failover service via a virtual IP address");
	...
	if (
		...
		thread_create(admin_thread,               "ADMINISTRATION",      NULL)
	)
		log_exit_fatal();
